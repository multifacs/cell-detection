...
IMAGE: str = "./images/colon-cancer-2x-photoshop.png"
...
plt.show()
cv2.imwrite('./output/Final_Output_colour.png', contrast_stretched_blurM)
...
cv2.imwrite('./output/Final_Output.png', edgeM)
